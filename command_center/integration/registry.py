...
#: The five known ecosystem projects, seeded on first read. Paths are the
#: conventional checkout locations; a path that does not exist on this
#: machine simply surfaces as `unconfigured`/`invalid_path` health — the
#: seed is configuration to edit, never an assertion.
DEFAULT_ENTRIES: list[dict[str, Any]] = [
    {
        ...
        "kind": "engine",
        "project": "AIOS",
        "repo_path": "~/Projects/aios",
        "remote": "dimastov-lab/aios",
        "default_branch": "main",
    },
    {
        ...
        "kind": "control_plane",
        "project": "AICC",
        "repo_path": "~/Projects/ai-command-center",
        "remote": "dimastov-lab/ai-command-center",
        "default_branch": "main",
    },
    {
        "id": "esf-enterprise",
        ...
        "kind": "domain_module",
        "project": "ESF",
        "repo_path": "~/Desktop/ESF-Enterprise-Clean-Starter",
        "remote": None,
        "default_branch": "main",
    },
    {
        "id": "aml-governance-platform",
        "name": "AML Governance Platform",
        "kind": "governance",
        "project": "AML",
        "repo_path": "~/Projects/AML-Governance-Platform",
        "remote": None,
        "default_branch": "main",
    },
    {
...
def normalize_entry(entry: dict) -> dict:
    ...
    kind = entry.get("kind") or "domain_module"
