...
def test_boolean_contract_version_is_not_accepted_as_integer_version_one():
    class _Response:
        def __enter__(self):
            return self
        ...
        def read(self, *_args):
            return (
                b'{"contract":"aios.core.status","contract_version":true,'
                b'"tenant_id":"bank-a","readiness":"ready","evidence":[]}'
            )
...
def test_ready_requires_complete_health_capability_gate_and_evidence_proof():
    class _Response:
        def __enter__(self):
            return self
        ...
        def read(self, *_args):
            return (
                b'{"contract":"aios.core.status","contract_version":1,'
                b'"tenant_id":"bank-a","readiness":"ready","health":"healthy",'
                b'"capabilities":[],"gates":[],"evidence":[]}'
            )
